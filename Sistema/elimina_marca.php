...
echo "<h4>Marca: $nmarcas</h5> ";
 
echo "<br><img src = '$ruta' height = 100 widht = 100  >";



echo "<br><br>Regresar<a href='marcas.php'</a>  <button class='btn btn-default'><i class='glyphicon glyphicon-arrow-left'></i></button> </a></li>
    Eliminar 

    <a href='elimina_marca1.php?idmar=$idmar'</a> <button class='btn btn-default'><i class='glyphicon glyphicon-remove'></i></button> </a></li>";
