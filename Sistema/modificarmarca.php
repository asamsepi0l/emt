...
$marcas = new marcas();
$marcas->setidmar($idmar);
$marcas->buscarmarcaporidmar();
$nmarcas = $marcas->getnmarcas();
$detalle = $marcas->getdetalle();
$activo = $marcas->getactivo();
$ruta= $marcas->getruta();
$archivo= $marcas->getarchivo();

echo "<form action='modificamarca2.php' method = 'POST' enctype='multipart/form-data'>";
echo "<table class='table' >";
echo "<input type='hidden'  class='form-control' readonly='readonly' name='idmar' value='$idmar'>";
echo "<tr><td>Marca</td><td><input type='text' class='form-control' name='nmarcas' value='$nmarcas'></td></tr>";
echo "<tr><td>Descripcion</td><td><input type='text' class='form-control' name='detalle' value='$detalle'></td></tr>";
...
echo "<tr><td>Selecciona nueva imagen</td>
          <td><input class='form-control' type = 'file' name = 'archivo'></td></tr>";
...
<center><button  type='submit' value='Guardar Cambios' class='btn btn-primary'><center>Actualizar</button>
