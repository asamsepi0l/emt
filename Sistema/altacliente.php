...
<tr><td>Nombre (s)</td><br><td><input required class='form-control' type = 'text' name = 'nombrecli' ><br>

<tr><td>Apellido (s) </td><td><input required class='form-control' type = 'text' name = 'appcliente' ><br>

<input required  type = 'radio' name = 'sexo' value = 'M ' > Hombre  
<input type = 'radio' name = 'sexo' value = 'F'>  Mujer<br><br>

<tr><td>Numero Telefónico </td><td><input required class='form-control' type = 'text' name = 'ntelcli'data-mask="(999) 999-9999" data-mask-placeholder="X">

<tr><td><br>E-Mail </td><td><input required class='form-control' type = 'text' name = 'emailcli'>
...
<br>
<br>Foto <br><br><input class="btn-XL"  type = 'file' name = 'archivo'><br>
</tr>
</table>
