...
echo "<h4>Nombre: $nproductos</h5> ";

echo "<h4></h4><br><img src = '$ruta' height = 100 widht = 100  ><br><br>";

  


echo "Regresar<a href='productos.php'</a>  <button class='btn btn-default'><i class='glyphicon glyphicon-arrow-left'></i></button> </a></li>
    Eliminar 

    <a href='eliminar_producto1.php?idprod=$idprod'</a> <button class='btn btn-default'><i class='glyphicon glyphicon-remove'></i></button> </a></li>";
