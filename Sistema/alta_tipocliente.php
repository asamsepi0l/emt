...
?>            
    ...
    <!-- Tablas (SELECT * CLIENTES) -->
        ...
        <div class="content-box-large">
          ...
          <div class="panel-title">Alta de Tipos de Clientes</div>
        </div>
...
<form action ='alta_tipocliente2.php' method = 'POST' enctype='multipart/form-data'>

<tr><td>Clave </td><td><input required class='form-control' type = 'text' name = 'idtipo' >
</td></tr>
<tr><td>Tipo</td><td><input required class='form-control' type = 'text' name = 'ctipo' >

<tr><td>Activo </td><td><input required type = 'radio' name = 'activo' value = 'SI' >SI    <input type = 'radio' name = 'activo' value = 'NO'>NO</td> </tr>

<tr><td>Descripcion</td><td><input required class='form-control' type = 'text' name = 'descripcion' >
